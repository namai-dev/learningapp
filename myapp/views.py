...
class Home(APIView):
    ...
    def post(self, request):
        ...
        if topic:
            ...
            return render(template_name="base.html", request=request, context={"videos":video, "topic":topic})
        return render(template_name="base.html", request=request, context={"topic":topic})
